...
class Utilisateur implements UserInterface {
     ...
     * @ORM\Id()
     * @ORM\GenerateValue()
     * @ORM\Column(tyme="integer")
     */
    private $idUtilisateur;


    /** @ORM\Column(type="string", lenght=20, nullable=true) */
    private $avatar;

    /** #ORM\Column(type="string", lenght=254) */
    private $email;

    /** #ORM\Column(type="string", lenght=300) */
    private $password;

    /** #ORM\Column(type="string", lenght=1) */
    private $sexe;
    ...
    /** #ORM\Column(type="integer", lenght=3) */
    private $taille;
